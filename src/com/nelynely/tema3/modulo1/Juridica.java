...
public class Juridica extends Pessoa {
    ...
    public Juridica(String nome, String CNPJ, String nacionalidade, String naturalidade) {
        super(nome, CNPJ, nacionalidade, naturalidade);
    }

    @Override
    protected boolean atualizarID(String identificador) throws ErroValidacaoCNPJ{
        if (validaCNPJ(CNPJ)) {
